...
const ReportsOlo = ({Reload,connErr, setConnErr }) => {
    ...
    const fillData = async () => {
        ...
        try{
            const result = (await axios.get("activeReports/company/Olo/rol/"+localStorage.usrRol)).data
            if(result){
