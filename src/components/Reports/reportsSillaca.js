...
const ReportsSillaca = ({Reload,connErr, setConnErr }) => {
    ...
    const fillData = async () => {
        ...
        try{
            const result = (await axios.get("activeReports/company/Sillaca/rol/"+localStorage.usrRol)).data
            if(result){
