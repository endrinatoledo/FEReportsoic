...
const ReportsMundiPartes = ({Reload,connErr, setConnErr }) => {
    ...
    const fillData = async () => {
        ...
        try{
            const result = (await axios.get("activeReports/company/MundiPartes/rol/"+localStorage.usrRol)).data
            if(result){
    ...
    let content = (
        ...
        <Row>
            <Col xs={24} md={24} lg={24} xl={24}>
                <Title level={3}>MundiPartes</Title>           
            </Col> 
        </Row>
        <Row>               
            <Col xs={24} md={24} lg={24} xl={24}>
...
export default ReportsMundiPartes;