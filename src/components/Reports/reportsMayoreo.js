...
const ReportsMayoreo = ({Reload,connErr, setConnErr }) => {
    ...
    const fillData = async () => {
        ...
        try{
            const result = (await axios.get("activeReports/company/Mayoreo/rol/"+localStorage.usrRol)).data
            if(result){
