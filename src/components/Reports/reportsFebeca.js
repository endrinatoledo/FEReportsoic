...
const ReportsFebeca = ({Reload,connErr, setConnErr }) => {
    ...
    const fillData = async () => {
        ...
        try{
            const result = (await axios.get("activeReports/company/Febeca/rol/"+localStorage.usrRol)).data
            if(result){
