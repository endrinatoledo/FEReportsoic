...
const ReportsCofersa = ({Reload,connErr, setConnErr }) => {
    ...
    const fillData = async () => {
        ...
        try{
            const result = (await axios.get("activeReports/company/Cofersa/rol/"+localStorage.usrRol)).data
            if(result){
